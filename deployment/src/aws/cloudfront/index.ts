...
export const createOpenNextDistribution = (
  ...
  return new Distribution(scope, 'Distribution', {
    ...
    additionalBehaviors: {
      [`${basePath}/api/*`]: props.serverFnBehaviour,
      [`${basePath}/_next/image*`]: props.imageFnBehaviour,
      [`${basePath}/_next/data/*`]: props.serverFnBehaviour,
      [`${basePath}/_next/*`]: props.staticFileBehaviour,
